<?php
/**
 * Yummy Bites Appearance Settings
 *
 * @package Yummy Bites
 */
if ( ! function_exists( 'yummy_bites_customize_register_typography' ) ) : 

function yummy_bites_customize_register_typography( $wp_customize ) {
    $defaults      = yummy_bites_get_typography_defaults();
    $fontsdefaults = yummy_bites_get_general_defaults();
    
    /** Typography */
    $wp_customize->add_section(
        'typography_settings',
        array(
            'title'    => __( 'Typography', 'yummy-bites' ),
            'priority' => 10
        )
    );
    ...
    $wp_customize->add_setting(
        ...
        array(
            ...
            'sanitize_callback' => 'yummy_bites_sanitize_variants',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Typography_Customize_Control(
            $wp_customize,
    ...
    $wp_customize->add_setting(
        ...
        array(
            ...
            'sanitize_callback' => 'yummy_bites_sanitize_empty_floatval',
            'transport'         => 'postMessage',
        )
    );
    $wp_customize->add_setting(
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Range_Slider_Control(
            ...
            array(
                'label'    => __( 'Line Height', 'yummy-bites' ),
                'section'  => 'typography_settings',
                'settings' => array(
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Range_Slider_Control(
            ...
            array(
                'label'    => __( 'Letter Spacing', 'yummy-bites' ),
                'section'  => 'typography_settings',
                'settings' => array(
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Group_Control( 
            ...
            array(
                ...
                'label'       => __( 'H1 Heading', 'yummy-bites' ),
                'section'     => 'typography_settings',
                'type'        => 'group',
                'style'       => 'collapsible',
            )
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Group_Control( 
            ...
            array(
                ...
                'label'       => __( 'H2 Heading', 'yummy-bites' ),
                'section'     => 'typography_settings',
                'type'        => 'group',
                'style'       => 'collapsible',
            )
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Group_Control( 
            ...
            array(
                ...
                'label'       => __( 'H3 Heading', 'yummy-bites' ),
                'section'     => 'typography_settings',
                'type'        => 'group',
                'style'       => 'collapsible',
            )
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Group_Control( 
            ...
            array(
                ...
                'label'       => __( 'H4 Heading', 'yummy-bites' ),
                'section'     => 'typography_settings',
                'type'        => 'group',
                'style'       => 'collapsible',
            )
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Group_Control( 
            ...
            array(
                ...
                'label'       => __( 'H5 Heading', 'yummy-bites' ),
                'section'     => 'typography_settings',
                'type'        => 'group',
                'style'       => 'collapsible',
            )
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Group_Control( 
            ...
            array(
                ...
                'label'       => __( 'H6 Heading', 'yummy-bites' ),
                'section'     => 'typography_settings',
                'type'        => 'group',
                'style'       => 'collapsible',
            )
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Toggle_Control( 
            ...
            array(
                'section'     => 'typography_settings',
                'label'       => __( 'Load Google Fonts Locally', 'yummy-bites' ),
                'description' => __( 'This will load Google fonts from your server to speed up your site and make it GDPR compliant.', 'yummy-bites' )
            )
        )
    );
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Toggle_Control( 
            ...
            array(
                'section'         => 'typography_settings',
                'label'           => __( 'Preload Local Fonts', 'yummy-bites' ),
                'description'     => __( 'Preloading Google fonts will speed up your website speed.', 'yummy-bites' ),
                'active_callback' => 'yummy_bites_performance_fonts'
            )
        )
    );
    ...
    $wp_customize->add_control(
        'flush_google_fonts',
        array(
            'label'       => __( 'Flush Local Fonts Cache', 'yummy-bites' ),
            'description' => __( 'Click the button to reset the local fonts cache.', 'yummy-bites' ),
            'type'        => 'button',
            'settings'    => array(),
            'section'     => 'typography_settings',
            'input_attrs' => array(
                'value' => __( 'Flush Local Fonts Cache', 'yummy-bites' ),
...
add_action( 'customize_register', 'yummy_bites_customize_register_typography' );