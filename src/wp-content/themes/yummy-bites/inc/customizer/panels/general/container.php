 ...
 * @package Yummy Bites
*/
if ( ! function_exists( 'yummy_bites_customize_register_general_container' ) ) : 

function yummy_bites_customize_register_general_container( $wp_customize ){
    ...
    $wp_customize->add_section( 
        ...
        array(
            'priority' => 10,
            'title'    => __( 'Container', 'yummy-bites' ),
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Range_Slider_Control(
            ...
            'container_width',
            array(
                'label'    => __( 'Container Width', 'yummy-bites' ),
    ...
    $wp_customize->add_control(
        new Yummy_Bites_Range_Slider_Control(
            ...
            'fullwidth_centered',
            array(
                'label'    => __( 'Fullwidth Centered Max-width', 'yummy-bites' ),
                'section'  => 'general_container_section',
                'settings' => array(
...
add_action( 'customize_register', 'yummy_bites_customize_register_general_container' );