	...
	'recommended_plugins' => array(
        ...
        'delicious-recipes' => array(
			...
			'description' => sprintf(
				...
				esc_html__( 'If you want to take full advantage of the features this theme has to offer, please install and activate %s plugin.', 'yummy-bites' ), '<strong>Delicious Recipes</strong>'
			),
		),
	),
