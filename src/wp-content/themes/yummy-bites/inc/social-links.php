...
class Yummy_Bites_Social_Lists{
     ...
     * @return void
     */
    public function yummy_bites_lists_all_svgs( $social ){
        if( !$social ){
            return;
        }
        switch ( $social ) {
            ...
            case 'share':
                return '<svg class="tasty-share" width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     * @return void
     */
    public function yummy_bites_all_social_icons(){
        $social_array = [ 
            [
                'key' => 'yummy_facebook',
                'value' => '#'
        ...
        $social_icons = apply_filters( 'yummy_social_icons',$social_array );
     ...
     * @return void
     */
    public function yummy_bites_social_links( $ed_social_media, $ed_social_media_newtab, $social_media_order ){
        $list_social = $this->yummy_bites_all_social_icons();
        if( $ed_social_media && $social_media_order ){ ?>
                <ul class="yummy-networks">
                    <?php 
                    foreach( $social_media_order as $link ){
                        $actualsocialkey = str_replace( 'yummy_','',$link );
                            ...
                            if( !empty( $value ) && $key == $link ){
                                ?>
                                    ...
                                    <a href="<?php if( isset( $value ) ) echo esc_url( $value ); ?>" target="<?php echo $ed_social_media_newtab ? '_blank': '_self'; ?>" rel="nofollow noopener">
                                        <?php echo wp_kses( $this->yummy_bites_lists_all_svgs( $actualsocialkey ), yummy_bites_get_kses_extended_ruleset() ); ?>
                                    </a>
                                </li>  
                                <?php 
                            }
