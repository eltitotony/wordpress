        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p class="dismiss-link"><strong><a href="?yummy_bites_admin_notice=1"><?php esc_html_e( 'Dismiss', 'yummy-bites' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function yummy_bites_update_admin_notice(){
    if ( isset( $_GET['yummy_bites_admin_notice'] ) && $_GET['yummy_bites_admin_notice'] = '1' ) {
