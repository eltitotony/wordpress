...
function yummy_bites_get_all_google_fonts(){
  $google_fonts = apply_filters( 'yummy_bites_google_lists', get_template_directory() . '/inc/typography/google-fonts-lists.php' );
  ...
  if ( apply_filters( 'yummy_bites_alphabetize_google_fonts', true ) ) {
    asort( $fonts );
  }

  // Filter to allow us to modify the fonts array
  return apply_filters( 'yummy_bites_google_fonts_array', $fonts );
