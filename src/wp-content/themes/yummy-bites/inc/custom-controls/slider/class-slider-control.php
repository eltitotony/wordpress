<?php
/**
 * Yummy_Bites Customizer Slider Control.
 * 
 * @package Yummy_Bites
*/
...
if ( ! class_exists( 'Yummy_Bites_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Yummy_Bites_Slider_Control extends WP_Customize_Control {

		public $type = 'yummy-bites-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'yummy-bites-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'yummy-bites-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
