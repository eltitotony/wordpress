<?php
/**
 * Yummy Bites Customizer Radio Image Control.
 * 
 * @package Yummy Bites
*/
...
if( ! class_exists( 'Yummy_Bites_Radio_Image_Control' ) ){
	/**
	 * Radio Image control (modified radio).
    */
	class Yummy_Bites_Radio_Image_Control extends WP_Customize_Control {

		public $type    = 'yummy-bites-radio-image';
		public $tooltip = '';
		public $col     = 'col-2';
		public $svg     = false;
		public $group;
        ...
        public function enqueue() {            
            wp_enqueue_style( 'yummy-bites-radio-image', get_template_directory_uri() . '/inc/custom-controls/radioimg/radio-image.css', null );
            wp_enqueue_script( 'yummy-bites-radio-image', get_template_directory_uri() . '/inc/custom-controls/radioimg/radio-image.js', array( 'jquery' ), false, true ); //for radio-image                
        }
		...
		protected function content_template() {
			...
			<div class="<# if ( ! data.collapsed ) { #>is-active<# } #><# if ( data.group ) { #>_{{ data.group }}<# } #>">
				...
				<div id="input_{{ data.id }}" class="image {{data.feat_class}}" data-col="{{ data.col }}">
