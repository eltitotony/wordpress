...
if( ! function_exists( 'yummy_bites_getting_started_menu' ) ) :
/**
 * Adding Getting Started Page in admin menu
 */
function yummy_bites_getting_started_menu(){	
	add_theme_page(
		__( 'Getting Started', 'yummy-bites' ),
		__( 'Getting Started', 'yummy-bites' ),
		'manage_options',
		'yummy-bites-getting-started',
		'yummy_bites_getting_started_page'
	);
}
endif;
add_action( 'admin_menu', 'yummy_bites_getting_started_menu' );

if( ! function_exists( 'yummy_bites_getting_started_admin_scripts' ) ) :
/**
 * Load Getting Started styles in the admin
 */
function yummy_bites_getting_started_admin_scripts( $hook ){
	// Load styles only on our page
	if( 'appearance_page_yummy-bites-getting-started' != $hook ) return;

    wp_enqueue_style( 'yummy-bites-getting-started', get_template_directory_uri() . '/inc/getting-started/css/getting-started.css', false, YUMMY_BITES_THEME_VERSION );
    
    wp_enqueue_script( 'plugin-install' );
    wp_enqueue_script( 'updates' );
    wp_enqueue_script( 'yummy-bites-getting-started', get_template_directory_uri() . '/inc/getting-started/js/getting-started.js', array( 'jquery' ), YUMMY_BITES_THEME_VERSION, true );
    wp_enqueue_script( 'yummy-bites-recommended-plugin-install', get_template_directory_uri() . '/inc/getting-started/js/recommended-plugin-install.js', array( 'jquery','plugin-install','wp-util','updates' ), YUMMY_BITES_THEME_VERSION, true );    

	$localize = array(
        'ajaxUrl'              => admin_url( 'admin-ajax.php' ),
        'ActivatingText'       => __( 'Activating', 'yummy-bites' ),
        'DeactivatingText'     => __( 'Deactivating', 'yummy-bites' ),
        'PluginActivateText'   => __( 'Activate', 'yummy-bites' ),
        'PluginDeactivateText' => __( 'Deactivate', 'yummy-bites' ),
        'SettingsText'         => __( 'Settings', 'yummy-bites' ),
        'BrowseTemplates'      => __( 'Browse Starter Templates', 'yummy-bites' )
    ); 
	wp_localize_script( 'yummy-bites-recommended-plugin-install', 'yummy_bites_start_page', $localize );
}
endif;
add_action( 'admin_enqueue_scripts', 'yummy_bites_getting_started_admin_scripts' );

if( ! function_exists( 'yummy_bites_call_plugin_api' ) ) :
/**
 * Plugin API
**/
function yummy_bites_call_plugin_api( $plugin ) {
...
function required_plugin_activate() {
    ...
    if ( ! current_user_can( 'install_plugins' ) || ! isset( $_POST['init'] ) || ! $_POST['init'] ) {
        wp_send_json_error(
            array(
                'success' => false,
                'message' => __( 'No plugin specified', 'yummy-bites' ),
            )
        );
    }
    ...
    wp_send_json_success(
        array(
            'success' => true,
            'message' => __( 'Plugin Successfully Activated', 'yummy-bites' ),
        )
    );
...
function required_plugin_deactivate() {
    ...
    wp_send_json_success(
        array(
            'success' => true,
            'message' => __( 'Plugin Successfully Deactivated', 'yummy-bites' ),
        )
    );
...
if( ! function_exists( 'yummy_bites_check_for_icon' ) ) :
/**
 * Check For Icon 
**/
function yummy_bites_check_for_icon( $arr ) {
	if( ! empty( $arr['svg'] ) ){
...
if( ! function_exists( 'yummy_bites_getting_started_page' ) ) :
/**
 * Callback function for admin page.
*/
function yummy_bites_getting_started_page(){ ?>
	<div class="wrap getting-started">
		<h2 class="notices"></h2>
		<div class="intro-wrap">
			<div class="intro">
				<h3><?php printf( esc_html__( 'Getting started with %1$s v%2$s', 'yummy-bites' ), YUMMY_BITES_THEME_NAME, YUMMY_BITES_THEME_VERSION ); ?></h3>
				<h4><?php printf( esc_html__( 'You will find everything you need to get started with %1$s below.', 'yummy-bites' ), YUMMY_BITES_THEME_NAME ); ?></h4>
			</div>
		</div>
			...
			<ul class="inline-list">
				<li class="current">
                    <a id="plugins" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Recommended Plugins', 'yummy-bites' ); ?>
                    </a>
                </li>
				<li>
                    <a id="help" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Getting Started', 'yummy-bites' ); ?>
                    </a>
                </li>
				<li data-id="demo">
					<a id="demo" href="javascript:void(0);">
						...
						<?php esc_html_e( 'Demo Import', 'yummy-bites' ); ?>
					</a>
				</li>
				<li>
                    <a id="support" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'FAQ\'s &amp; Support', 'yummy-bites' ); ?>
                    </a>
                </li>
				<li>
                    <a id="free-pro-panel" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Free Vs Pro', 'yummy-bites' ); ?>
                    </a>
                </li>
			</ul>
